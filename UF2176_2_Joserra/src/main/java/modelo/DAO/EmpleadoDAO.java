...
public class EmpleadoDAO {
	...
	public ArrayList<Empleado> mostrar (String criterioBusqueda) throws Exception {//(int codigo, String nif,String nombre,String ape1, String ape2)throws Exception {
	...
	+ "WHERE CONCAT(e.nombre,ape1,ape2,nif)LIKE '%" +criterioBusqueda  +"%' "
